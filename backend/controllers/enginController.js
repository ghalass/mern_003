...
exports.addEngin = async (req, res) => {
    try {
...
exports.getAllEngins = async (req, res) => {
    try {
        const engins = await prisma.engin.findMany({ orderBy: { createdAt: "desc" } })
        res.status(200).json({ message: "Enregistrements récupérés avec succès.", engins })
...
exports.deleteEngin = async (req, res) => {
    const { id } = req.params
    try {
...
exports.updateEngin = async (req, res) => {
    const { id } = req.params
    const { name } = req.body
...
exports.downloadEnginsExcel = async (req, res) => {
    try {
